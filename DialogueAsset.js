...
/// A Dialogue.js Asset
/// 
/// Based on Dialogue.js found at https://github.com/scottbw/dialoguejs/blob/master/
/// </summary>
///
/// <returns>
...
function DialogueAsset() {
    ...
    /// </summary>
    var result = {
        LoadScript: function (player, script) {
            Dialogue.load(player, script);
        },

        Interact: function (actor, player, response) {
            return Dialogue.interact(actor, player, response);
        },
