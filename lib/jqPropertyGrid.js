...
(function ($) {
    ...
    function getPropertyRowHtml(pgId, name, value, meta, postCreateInitFuncs, getValueFuncs) {
        ...
        if (type === 'boolean' || (type === '' && typeof value === 'boolean')) {
            ...
            valueHTML = '<textarea id="' + elemId + '"' +
                ((typeof meta.options === 'undefined') ? '' :
                 ((typeof meta.options.rows === 'undefined') ? '' : ' rows="' + meta.options.rows + '"') +
                 ((typeof meta.options.cols === 'undefined') ? '' : ' cols="' + meta.options.cols + '"')
                ) +
                '></textarea>';
            if (getValueFuncs) { getValueFuncs[name] = function () { return $('#' + elemId).prop('value'); }; }
